        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu"><a href="javascript:;"> <i
                    ...
                    <ul class="sub">
                        <li><a href="blank.html">部门信息</a></li>
                        <li><a href="login.html">添加部门</a></li>
                    </ul>
                </li>
                <li class="sub-menu"><a href="javascript:;"> <i
                ...
                <div class="col-lg-9 main-chart">
                            ...
                            <div class="content-panel">
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class=" fa fa-edit"></i> 部门名称</th>
                                        <th><i class=" fa fa-edit"></i> 部门标签</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-xs">
                                                    <a href="toUpdateUser?id=${Item.id}"
                                                       style="color: white;">
                    ...
                    <div class="card-body">
                        <nav aria-label="Page navigation example"
                            ...
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="#">【${pageInfo.pageIndex}/${pageInfo.pages}，共${pageInfo.total}条记录】
                                </a></li>
                                ...
                                <li class="page-item"><a class="page-link"
                                                         href="javascript:jumpPage(${pageInfo.pageIndex})">${pageInfo.pageIndex}</a></li>
                    ...
                    <!-- 分页提交的请求表单 -->
                    <form class="search" id="form_query" action="queryDept">
